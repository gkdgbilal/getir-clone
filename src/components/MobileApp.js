...
function MobileApp() {
  return (
    <div className="bg-primary-brand-color flex flex-col md:flex-row items-center justify-between bg-mobile-app  mt-7 md:rounded-lg text-white">
      ...
      <picture className="pt-8 hidden md:block lg:self-end">
        <img
